...
/// Eighteen archetypes today and thirty-two next month: the assembler is asked
/// to survive the shape, not a particular set of sentences.
ContentPack loadPack() =>
    ContentPack.fromJson(aContentPackJson(archetypes: 18));
...
void main() {
  ...
  group('assembly', () {
    ...
    test('every archetype reads every day, and none of them is empty', () {
