...
class Question {
  ...
  bool operator ==(Object other) =>
      ...
      other is Question && other.id == id && other.text == text;
  ...
  static List<Question> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<Question>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = Question.listFromJson(
          entry.value,
          growable: growable,
        );
      }
